...
public class PatientNotificationConfigForm extends JFrame {
    ...
    private boolean isNotificationExpanded = true;
    private boolean isAppointmentExpanded = false;

    public PatientNotificationConfigForm() {
    ...
    private void navigateToDashboard() {
        ...
        PatientNotificationConfigForm.this.dispose();
    }
